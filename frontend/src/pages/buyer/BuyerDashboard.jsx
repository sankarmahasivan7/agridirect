  ...
  const quickActions = [
    {
      ...
      desc: 'Browse farm-direct listings with live GPS & AI pricing',
      icon: Store,
    ...
    {
      title: 'My Cart',
      desc: 'Review selected produce and transparent logistics breakdown',
      icon: ShoppingCart,
      link: '/buyer/cart',
    ...
    {
      title: 'My Orders',
      desc: 'Track order statuses, invoices, and delivery fulfillment',
      icon: ClipboardList,
      link: '/buyer/orders',
    ...
    },
    {
      ...
      desc: 'Real-time vehicle GPS & route tracking on OpenStreetMap',
      icon: Truck,
    ...
    },
    {
      ...
      desc: 'Submit institutional requirements matched to verified farmers',
      icon: Layers,
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-leaf-700/50 text-leaf-200 text-xs font-semibold mb-3 border border-leaf-600/50">
              ...
              Direct Farm-to-Fork Sourcing
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold font-display">Buyer Command Center</h1>
            <p className="text-leaf-200 text-sm mt-1 max-w-xl">
              Source harvest-fresh crops directly from verified farmers & FPOs with zero middleman commissions and real-time logistics tracking.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
          <div className="card border-l-4 border-l-leaf-500 relative overflow-hidden group">
            ...
            <p className="text-xs text-leaf-700 font-medium mt-2 flex items-center gap-1">
              <ShieldCheck className="w-3.5 h-3.5" /> 100% Direct from verified growers
            </p>
          </div>

          <div className="card border-l-4 border-l-emerald-500 relative overflow-hidden group">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Total Spent</span>
            ...
            <p className="text-xs text-gray-400 mt-2">
              {data?.message || 'Cumulative procurement total'}
            </p>
          </div>

          <div className="card border-l-4 border-l-sky-500 relative overflow-hidden group sm:col-span-2 lg:col-span-1">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-semibold text-gray-500 uppercase tracking-wider">Estimated Savings</span>
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="badge-ai">AI Metric</span>
            </div>
            <p className="text-xs text-gray-500 mt-2">Saved by eliminating APMC middleman brokerage</p>
          </div>
        </div>
      )}
      ...
      <div className="mb-8">
        <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
          ...
          Buyer Navigation & Procurement Tools
        </h2>
